...
public class AlarmService extends Service {
    ...
    private void launchAlarmActivity(String medName, String dose, String meal, int reminderId) {
        try {
            ...
            alarmIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_NO_USER_ACTION);
    ...
    private Notification createServiceNotification() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID).setContentTitle("MediRemind Alarm Service").setContentText("Preparing alarm...").setSmallIcon(R.drawable.ic_medication).setContentIntent(pendingIntent).setPriority(NotificationCompat.PRIORITY_LOW).build();
    }

    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel serviceChannel = new NotificationChannel(CHANNEL_ID, "Alarm Service Channel", NotificationManager.IMPORTANCE_LOW);
