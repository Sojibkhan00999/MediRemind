...
public class PermissionHelper {
    ...
    private void requestNotificationPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            new AlertDialog.Builder(activity)
                ...
                .setMessage("রিমাইন্ডার কাজ করার জন্য নোটিফিকেশন অনুমতি দিন।")
    ...
    private void requestExactAlarmPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            new AlertDialog.Builder(activity)
                .setTitle("সঠিক সময়ে অ্যালার্ম অনুমতি")
                .setMessage("রিমাইন্ডার সঠিক সময়ে কাজ করার জন্য 'Alarms & reminders' অনুমতি চালু করুন।")
                .setPositiveButton("সেটিংস খুলুন", (dialog, which) -> {
    ...
    private void requestDisableBatteryOptimization() {
        new AlertDialog.Builder(activity)
            ...
            .setMessage("রিমাইন্ডার সব সময় কাজ করার জন্য এই অ্যাপের ব্যাটারি অপটিমাইজেশন বন্ধ করুন।")
            .setPositiveButton("সেটিংস খুলুন", (dialog, which) -> {
